...
void printTreePreOrder(simpul *root){
    if(root != NULL){
        ...
        printTreePreOrder_(root->left);
        printTreePreOrder_(root->right);
    }
}
void printTreePreOrder_(simpul *root){
    if(root != NULL){
        printf(" - %c", root->kontainer);
        printTreePreOrder_(root->left);
        printTreePreOrder_(root->right);
...
void printTreePostOrder(simpul *root){
    if(root != NULL){
        printTreePostOrder_(root->left); 
        printTreePostOrder_(root->right); 
        printf("%c", root->kontainer);
    }
}
void printTreePostOrder_(simpul *root){
    if(root != NULL){
        printTreePostOrder_(root->left); 
        printTreePostOrder_(root->right); 
        printf("%c - ", root->kontainer);
